...
// Typing Effect - DÉSACTIVÉ car pas d'élément #auto-input
/*
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showPage(pageNumber) {
        console.log('=== PROJETS: Affichage de la page', pageNumber, '===');
        console.log('Nombre total de projets:', allProjects.length);
        console.log('Projets par page:', projectsPerPage);
        
        // Cacher tous les projets
        allProjects.forEach((project, index) => {
            project.style.cssText = 'display: none !important;';
            project.classList.remove('active');
            console.log('Projet', index + 1, '- Caché');
        });
        ...
        for (let i = startIndex; i < endIndex && i < allProjects.length; i++) {
            allProjects[i].style.cssText = 'display: block !important;';
            console.log('Projet', i + 1, '- Affiché');
    ...
    // Initialisation
    console.log('Initialisation du carrousel de projets');
    
    // Retirer la classe initial-load pour que le JS prenne le contrôle
    projectsContainer.classList.remove('initial-load');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showPageServices(pageNumber) {
        ...
        allServices.forEach(service => {
            service.style.cssText = 'display: none !important;';
        ...
        for (let i = startIndex; i < endIndex && i < allServices.length; i++) {
            allServices[i].style.cssText = 'display: flex !important;';
            // Animation d'apparition avec un léger délai
            setTimeout(() => {
    ...
    // Initialisation
    console.log('Initialisation du carrousel de compétences');
    
    // Retirer la classe initial-load pour que le JS prenne le contrôle
    servicesContainer.classList.remove('initial-load');
